...
\begin{proof}
	...
	Ainsi d'après \autoref{CTT} il existe $\alpha(t)>0$ et% $\beta(t)\in\R$ (tels que $t \mapsto \ąlpha(t)$ et $t \mapsto \beta(t)$ mesurables comme limite simples de fonctions mesurables) telles que 
