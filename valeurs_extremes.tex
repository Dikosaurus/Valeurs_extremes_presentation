...
\begin{proof}
	...
	$$P(M_{\lfloor nt \rfloor} \leq a_{\lfloor nt \rfloor} x + b_{\lfloor nt \rfloor}) = F(a_{\lfloor nt \rfloor} x + b_{\lfloor nt \rfloor}) \substackrel{n\to \infty}{\longrightarrow} H(x).$$
\end{proof}
\end{document}