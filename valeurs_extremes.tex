...
la fonction de répartition de la loi de Paretto.

Soient $V_1,\cdots , V_n $ des v.a. iid de loi $F_V$ et $(k(n))_{n \in\N^*}$ une suite d'entiers telle que $1 \leq k(n)\leq n$ et 
$$
